...
function myprofile1(){
  ...
  //alert(d);
  xhttp.open("GET", "myprofile_doct.php?emailid="+em, true);
  xhttp.send();
}
...
<body>
<body style="background-size: cover; background-image: url(images/doctor.jpeg);" onload="javascript:myprofile1()" >
...
<button class="tablinks" onclick="myprofile1()"
id="defaultOpen">My Profile</button>
<button class="tablinks" onclick="view_disease()">View diseases</button>
